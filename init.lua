    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- NOTE Replacing telescope LSP actions with Lspsaga

          map('<leader>ca', '<cmd>Lspsaga code_action<CR>', '[C]ode [A]ction')
          map('<leader>rn', '<cmd>Lspsaga rename<CR>', '[R]e[n]ame')
          map('gf', '<cmd>Lspsaga finder<CR>', '[G]o to [F]inder')
          map('gd', '<cmd>Lspsaga peek_definition<CR>', '[G]oto (Peek) [D]efinition')
          map('<leader>d', '<cmd>Lspsaga show_line_diagnostics<CR>', 'Show Line [D]iagnostics')
          map('<leader>d', '<cmd>Lspsaga show_cursor_diagnostics<CR>', 'Show Cursor [D]iagnostics')
          map('<leader>o', '<cmd>Lspsaga outline<CR>', 'Toggle [O]utline')
